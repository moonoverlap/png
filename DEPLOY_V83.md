...
```powershell
cd "C:\Users\user\OneDrive\Desktop\압축파일\image-toolkit-v83-catalog-package-box-lock"
...
git status
git add -A
git commit -m "Add catalog package box lock"
git push origin main
```

확인: https://moonoverlap.github.io/png/?v=83
