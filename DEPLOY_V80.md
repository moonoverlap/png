...
압축을 푼 `image-toolkit-v80-tested-envelope-lock` 폴더에서 실행합니다.
...
git status
git add -A
git commit -m "Fix product package holes with tested envelope lock"
...
```text
https://moonoverlap.github.io/png/?v=80
```
